...
export class ContactsController {
  ...
  @Post("import")
  @RequirePermissions("contact.create")
  importCsv(@Body() input: ImportContactsDto) {
  ...
  listAddresses(@Param("id", ParseUUIDPipe) id: string) {
    return this.contacts.listAddresses(id);
  }
  ...
  addAddress(
    ...
    @Body() input: CreateContactAddressDto,
  ) {
    return this.contacts.addAddress(id, input);
  }
  ...
  updateAddress(
    ...
    @Body() input: UpdateContactAddressDto,
  ) {
    return this.contacts.updateAddress(id, addressId, input);
  }
  ...
  archiveAddress(
    ...
    return this.contacts.archiveAddress(id, addressId);
  }
