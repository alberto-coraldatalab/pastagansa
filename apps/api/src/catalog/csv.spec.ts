...
describe("parseCatalogCsv", () => {
  const header =
    "type,sku,name,description,unit,sales_price,currency,suggested_tax_code,revenue_account_code,expense_account_code,track_inventory";
  ...
  it("rejects inventory tracking for services", () => {
    expect(() =>
      parseCatalogCsv(
        `${header}\nSERVICE,S-1,Consulting,,hour,100,EUR,,,,true`,
      ),
