...
| Hito U — Producto usable               | En curso     | U2 — Venta usable y U3 — Compra usable están completadas y protegidas por E2E real de Chromium. U4 ya ofrece resumen tenant-scoped, diario/mayor, conciliación bancaria y estado observable del envío de facturas; faltan SMTP real en staging, restauración y prueba moderada. U0 y U1 conservan pendientes de demo, multiempresa y accesibilidad. Detalle en `docs/05_plan_producto_usable.md`.                                                                                                                                                                                                                                                                                                                                                                               |
