...
| Hito U — Producto usable               | En curso     | U2 — Venta usable y U3 — Compra usable están completadas y protegidas por E2E real de Chromium. U4 ya ofrece resumen tenant-scoped, diario/mayor, conciliación bancaria, alternativa PDF, stack reproducible y ensayo automatizado de restauración. SMTP real queda aplazado y ya no bloquea el hito; faltan publicar staging y realizar la prueba moderada. U0 y U1 conservan pendientes de demo, multiempresa y accesibilidad. Detalle en `docs/05_plan_producto_usable.md`.                                                                                                                                                                                                                                                                                                                                                                               |
