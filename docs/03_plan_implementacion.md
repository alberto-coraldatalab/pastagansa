...
| Fase 10 — SIF/VERI\*FACTU              | En curso     | La emisión genera transaccionalmente un registro SIF de alta versionado, append-only, aislado por tenant y encadenado de forma única por empresa. La huella SHA-256 reproduce los vectores oficiales AEAT 0.1.2; 101 emisiones concurrentes validan posiciones, enlaces e inmutabilidad en PostgreSQL y la web muestra el resultado en la trazabilidad. Pendientes XML completo, clasificación R1–R5, anulación, QR, remisión, firma/eventos cuando apliquen, declaración responsable y validación AEAT.                                                                                                                                                                                                                                                                                            |
...
**Estado real:** En curso. Implementado el primer slice de foundation: cada emisión
...
trazabilidad web muestra posición, algoritmo, versión y huella abreviada. Las
rectificativas se clasifican provisionalmente como R4 hasta incorporar la selección
jurídica R1–R5. Pendientes XML completo, anulación, QR, sender VERI\*FACTU,
