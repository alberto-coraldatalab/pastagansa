...
| Hito U — Producto usable               | En curso     | U0–U3 están completadas: existe arranque reproducible, seed demo idempotente, acceso y selector multiempresa validado en servidor, y los recorridos críticos están protegidos por E2E real de Chromium con auditorías WCAG automáticas. U4 ya ofrece resumen tenant-scoped, diario/mayor, conciliación bancaria, alternativa PDF, restore drill, workflow de aceptación contra HTTPS y guion moderado. El primer despliegue público reveló grants incompletos en el volumen; la migración 25 los repara y endurece readiness. SMTP no bloquea; falta redesplegar, superar aceptación y realizar la prueba externa. Detalle en `docs/05_plan_producto_usable.md`.                                                                                                                                    |
