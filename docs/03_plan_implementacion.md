...
| Fase 3 — Ventas                        | En curso     | Presupuestos completos hasta PDF y transiciones con precondición explícita de estado; borradores, series, emisión idempotente y numeración atómica de facturas validados en PostgreSQL, incluida una prueba de 100 emisiones simultáneas. PDF oficial y outbox transaccional SMTP implementados. Facturas rectificativas totales, parciales y por diferencias ya tienen relación con la original, motivo, impacto, serie propia, límites concurrentes, auditoría y PDF, con migración y flujo integral validados en PostgreSQL local. Pendientes confirmación en CI, SMTP de staging, pedidos, albaranes, recurrencia, vencimientos/pagos y UX web. |
