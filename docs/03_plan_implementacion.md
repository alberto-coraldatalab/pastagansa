...
|---|---|---|
| Fase 0 — Descubrimiento y arquitectura | En curso | Especificaciones funcional, técnica, UI/UX y este plan están versionadas; existe repositorio, Docker local, CI con PostgreSQL configurada y tooling de build/lint/test/audit. Descubrimiento de tests y runtime Node 22 corregidos; ejecución completa de integración pendiente de validación. Pendientes ADRs, despliegue staging y matriz normativa validada. |
