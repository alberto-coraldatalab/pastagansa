...
| Hito U — Producto usable               | En curso     | U2 — Venta usable y U3 — Compra usable están completadas y protegidas por E2E real de Chromium. La compra cubre proveedor → borrador → adjuntos → OCR/revisión humana → aprobación → pago, con persistencia y trazabilidad fiscal/contable. U0 y U1 conservan sus pendientes de demo, multiempresa y accesibilidad; el siguiente gate es U4 staging/visibilidad. Detalle en `docs/05_plan_producto_usable.md`.                                                                                                                                                                                                                                                                                                                                                                                      |
