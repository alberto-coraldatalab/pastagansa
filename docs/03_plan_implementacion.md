...
| Fase 3 — Ventas | En curso | Presupuestos completos hasta PDF; borradores de factura y series documentales por empresa implementados con snapshots, cálculo decimal, CRUD, RBAC, auditoría, RLS y constraints de tenant, pendientes de validación PostgreSQL en CI. Pendientes emisión/numeración atómica, pedidos, albaranes, rectificativas, recurrencia, email y UX web. |
...
**Estado real:** En curso. Implementados presupuestos hasta PDF y borradores de factura con líneas, totales decimales, snapshots de emisor/cliente/dirección/email, paginación opaca y CRUD restringido al estado borrador. Implementadas también series documentales configurables por empresa, con migración RLS y constraints de tenant; validación PostgreSQL pendiente en CI. Pendientes emisión/numeración atómica, email, rectificativas, recurrentes, vencimientos y pagos.
