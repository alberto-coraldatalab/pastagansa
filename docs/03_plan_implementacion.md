...
| Hito U — Producto usable               | En curso     | U0, U2 y U3 están completadas: existe arranque reproducible, seed demo idempotente verificado en CI y los recorridos críticos están protegidos por E2E real de Chromium con auditorías WCAG automáticas. U4 ya ofrece resumen tenant-scoped, diario/mayor, conciliación bancaria, alternativa PDF y ensayo automatizado de restauración. SMTP real queda aplazado y ya no bloquea el hito; faltan publicar staging, selector multiempresa y prueba moderada. Detalle en `docs/05_plan_producto_usable.md`.                                                                                                                                                                                                                                                                                          |
