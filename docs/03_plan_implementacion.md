...
| -------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fase 0 — Descubrimiento y arquitectura | En curso     | Especificaciones funcional, técnica, UI/UX y este plan están versionadas; existe repositorio, Docker local y CI con PostgreSQL 17, migraciones, lint, build, 17 pruebas unitarias, pruebas integrales de aislamiento/concurrencia y auditoría de dependencias. La emisión de 100 facturas simultáneas, su idempotencia y la inmutabilidad posterior ya están validadas en PostgreSQL. La primera ejecución CI del outbox detectó una suposición incorrecta sobre la existencia del rol de aplicación durante migraciones limpias; corregida mediante el mecanismo de privilegios por defecto ya definido y pendiente de repetir. Pendientes ADRs, despliegue staging y matriz normativa validada. |
...
| Fase 3 — Ventas                        | En curso     | Presupuestos completos hasta PDF y transiciones con precondición explícita de estado; borradores, series, emisión idempotente y numeración atómica de facturas validados en PostgreSQL, incluida una prueba de 100 emisiones simultáneas. PDF oficial de factura y outbox transaccional SMTP con RLS, reclamación concurrente, reintentos y seguimiento ya están implementados; pasan validación local, incluida inspección visual del PDF, y esperan CI PostgreSQL. Pendientes validación contra SMTP de staging, pedidos, albaranes, rectificativas, recurrencia y UX web.                                                                                                                      |
