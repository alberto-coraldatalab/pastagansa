...
| Hito U — Producto usable               | En curso     | U2 — Venta usable está completada. U3 ya cubre en web proveedor → borrador editable → aprobación → pago, con trazabilidad fiscal/contable y persistencia protegidas por E2E real de Chromium; faltan adjuntos y revisión OCR para cerrar el gate de compra. U0 y U1 conservan sus pendientes de demo, multiempresa y accesibilidad; después seguirá U4 staging/visibilidad. Detalle en `docs/05_plan_producto_usable.md`.                                                                                                                                                                                                                                                                                                                                                                           |
