...
| Fase 2 — Maestros | En curso | CRUD con archivado, permisos, auditoría y scope de empresa para contactos cliente/proveedor y catálogo de productos/servicios; importación CSV validada para contactos. Pendientes direcciones y condiciones comerciales, importación CSV de catálogo, filtros/paginación por cursor, UX web y configuración fiscal/contable validada. |
