...
**Estado real:** En curso. Implementados plan contable inicial inspirado en PGC, cuentas configurables, ejercicios y periodos mensuales, diario equilibrado, contabilización automática de facturas de venta, rectificativas, compras con IVA parcialmente deducible y cobros de cliente contra bancos, asiento manual idempotente, numeración anual serializada, reversión, bloqueo de periodos, balance de sumas y saldos, auditoría, permisos, RLS e invariantes de inmutabilidad/equilibrio en PostgreSQL. El gate técnico mínimo de asiento inmutable, reversión y periodo protegido está cubierto por pruebas integrales; la fase permanece abierta hasta incorporar reglas configurables, pagos a proveedor, conciliación, diario/mayor exportable e informes/cierre básicos.
