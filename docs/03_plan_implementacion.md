...
| Hito U — Producto usable               | En curso     | U0–U3 están completadas: existe arranque reproducible, seed demo idempotente, acceso y selector multiempresa validado en servidor, y los recorridos críticos están protegidos por E2E real de Chromium con auditorías WCAG automáticas. U4 ofrece resumen tenant-scoped, diario/mayor, conciliación bancaria, alternativa PDF, restore drill, workflow HTTPS y guion moderado. La migración 25 reparó los grants del primer despliegue y la aceptación pública posterior pasó 2/2 recorridos el 14/09/2026. SMTP no bloquea; solo falta la prueba moderada externa para cerrar U4. Detalle en `docs/05_plan_producto_usable.md`.                                                                                                                                                                    |
