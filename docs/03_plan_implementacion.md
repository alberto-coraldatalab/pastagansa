...
|---|---|---|
| Fase 0 — Descubrimiento y arquitectura | En curso | Especificaciones funcional, técnica, UI/UX y este plan están versionadas; existe repositorio, Docker local, CI con PostgreSQL configurada y tooling de build/lint/test/audit. Descubrimiento, runtime Node 22 y wiring DI de integración corregidos; ejecución completa pendiente de validación. Pendientes ADRs, despliegue staging y matriz normativa validada. |
