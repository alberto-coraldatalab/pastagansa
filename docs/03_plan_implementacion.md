...
| Hito U — Producto usable               | En curso     | U2 — Venta usable está completada y protegida por E2E real de navegador: registro → cliente → catálogo → borrador → emisión → PDF → cobro, con persistencia tras recarga y trazabilidad fiscal/contable. U0 y U1 conservan sus pendientes de demo, multiempresa y accesibilidad; los próximos gates son U3 compra usable y U4 staging/visibilidad. Detalle en `docs/05_plan_producto_usable.md`.                                                                                                                                                                                                                                                                                                                                                                                                    |
